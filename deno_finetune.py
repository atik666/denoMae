...
num_modality = 5 # change the number of modalities it is trained on

# Load pre-trained MultiMAE model
pretrained_model = DenoMAE(num_modality, img_size, patch_size, in_chans, embed_dim, encoder_depth, decoder_depth, num_heads)
...
path = '/mnt/d/OneDrive - Rowan University/RA/Summer 24/MMAE_Wireless/DenoMAE/data/labeled/-10dB/'
